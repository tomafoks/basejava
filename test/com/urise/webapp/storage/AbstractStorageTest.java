...
public abstract class AbstractStorageTest {
    ...
    private final static String FULLNAME_1 = "Ivan1";
    private final static String FULLNAME_2 = "Ivan2";
    private final static String FULLNAME_3 = "Ivan3";
    private final static String FULLNAME_4 = "Ivan4";
    ...
    public void testSave() {
        final Resume res = new Resume(UUID_4, FULLNAME_4);
        storage.save(res);
        assertGet(res);
    }
